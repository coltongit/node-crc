...
var crc15 = (0, _define_crc2.default)('crc-15', function (buf, previous) {
  ...
  for (var index = 0; index < buf.length; index++) {
    var byte = buf[index];
    crc = (TABLE[(crc >> 7 ^ byte) & 0xff] ^ crc << 8) & 0x7fff;
  }

  return crc;
});

exports.default = crc15;